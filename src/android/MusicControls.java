    ...
    if (action.equals("create")) {
      ...
      this.cordova.getThreadPool().execute(new Runnable() {
        public void run() {
          ...
          metadataBuilder.putString(MediaMetadataCompat.METADATA_KEY_DATE, infos.date);
          metadataBuilder.putString(MediaMetadataCompat.METADATA_KEY_DURATION, infos.duration);
  ...
  private void setMediaPlaybackState(int state) {
    ...
    if (state == PlaybackStateCompat.STATE_PLAYING) {
      playbackstateBuilder.setActions(PlaybackStateCompat.ACTION_PLAY_PAUSE | PlaybackStateCompat.ACTION_PAUSE
          ...
          | PlaybackStateCompat.ACTION_SET_RATING | PlaybackStateCompat.ACTION_SEEK_TO);
      playbackstateBuilder.setState(state, this.position, 1.0f, System.elapsedRealtime());
    } else {
      playbackstateBuilder.setActions(PlaybackStateCompat.ACTION_PLAY_PAUSE | PlaybackStateCompat.ACTION_PLAY
          ...
          | PlaybackStateCompat.ACTION_PREPARE | PlaybackStateCompat.ACTION_PREPARE_FROM_SEARCH
          | PlaybackStateCompat.ACTION_SET_RATING | PlaybackStateCompat.ACTION_SEEK_TO);
      playbackstateBuilder.setState(state, this.position, 0, System.elapsedRealtime());
    }
